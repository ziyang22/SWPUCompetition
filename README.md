...
自适应搜索通过动态调整步长，进一步提升计算性能：

| 深度范围 | 固定步长 | 自适应搜索 | 性能提升 |
|---------|---------|-----------|---------|
| 100m | 200 窗口, 1.9s | 14 窗口, 0.11s | **17.3x** |
| 1000m | 2000 窗口, 9.3s | 104 窗口, 0.44s | **21.1x** |
...
# 运行性能对比测试
./benchmark.sh 3000 4000
```

**详细文档：** [自适应搜索模式使用指南](ADAPTIVE_SEARCH_GUIDE.md)
